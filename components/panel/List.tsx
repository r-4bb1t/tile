    ...
    () =>
      [
        ...
        },
        {
          ...
          assets: [
            { type: "string", str: "List", style: { fontWeight: 700, fontSize: "1.25rem", marginTop: "0.5rem" } },
        ...
        },
        {
          ...
          assets: [
            { type: "string", str: "Grid", style: { fontWeight: 700, fontSize: "1.25rem", marginTop: "0.5rem" } },
            {
              type: "grid",
              items: [
                { type: "icon", icon: "heart", attributes: { classname: "p-2", size: "100%" } },
